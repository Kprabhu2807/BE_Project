 ...
 */
@WebServlet("/RealTweepy")
public class RealTweepy extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      cb.setDebugEnabled(true)
		...
		.setOAuthConsumerKey("fxh44CgaNtbaIx5BWyYBRN9kD")
	    .setOAuthConsumerSecret("A3vPK1UIvfKPgUlASAW1dACjHxrRZbmqg2c1mQaciox8jI20Bi")
	    .setOAuthAccessToken("1518502758197866496-7J1KOVg3QcNgybwkTyvUEBhz8N36AM")
	    .setOAuthAccessTokenSecret("H9UbKv6iuc994b1bKhi6nJUj9a7f0pRqSuai3wHTuRSeJ")
