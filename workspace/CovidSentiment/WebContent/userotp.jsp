...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
			...
			<h2 style="color:white" class="collapse navbar-collapse nav navbar-nav top-menu" align="center">Covid-19 Negative Sentiment Classification on Twitter</h2>
            ...
            <form class="form-horizontal" action="UserLoginController" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="email" class="form-control" placeholder="Enter OTP" name="email">
                    </div>
